...
const STATUS_CONFIG: Record<RequestStatus, { label: string; className: string }> = {
  ...
  cab_in_progress:        { label: "Design In Progress",      className: "bg-blue-100 text-blue-700 border-blue-200" },
  cab_completed:          { label: "Design Complete",         className: "bg-purple-100 text-purple-700 border-purple-200" },
